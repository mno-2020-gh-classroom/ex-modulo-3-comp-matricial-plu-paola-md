...
El proceso de unit testing, para poder ejecutar los test de forma interactiva y en un entorno **aislado** se utilzó `binder` y la imagen de docker disponible en la (carpeta) [https://github.com/mno-2020-gh-classroom/ex-modulo-3-comp-matricial-plu-paola-md/tree/master/docker] de este repositorio.  

# Instrucciones para ejcución en `Binder`
