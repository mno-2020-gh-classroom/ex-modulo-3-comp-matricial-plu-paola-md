...
def revision_x(num_corridas,dim_limite_inf,dim_limite_sup,entradas_lim_inf,entradas_lim_sup):
    ...
    sistema, el estado de la verificación de la solución (Ej: Correcto o Incorrecto) y el error relativo 
    entre x_est y x_real. 
    ...
    veces que se requiere quer se corra el algoritmo, el límite inferior y superior de la dimensión de la 
    ...
    * Entradas:
        ...
        la matriz como entrada
    * Salidas:
        - resultados_x (data frame): data frame con 5 columnas: dimension_A, condicion_A, tiempo_x, 
        estado_x y error_absoluto
    ==========
    Ejemplo:
        >> num_corridas = 3
        >> dim_limite_inf = 2 
    ...
    for i in range(0,num_corridas):
        ...
        error_absoluto.append(error_rel)
         
    data={'dimension_A':dimension_A,'condicion_A':condicion_A,'tiempo_x':tiempo_x,'estado_x':estado_x,'error_absoluto':error_absoluto}       
...
def revision_bloques(num_corridas,dim_limite_inf,dim_limite_sup,entradas_lim_inf,entradas_lim_sup):
    ...
    solución (Ej: Correcto o Incorrecto) y el error absoluto entre solucion_bloques y solucion_real. 
    
    Para cumplir con el objetivo principal, la función llama a otras funciones auxiliares: crea_matrices, 
    condicion y resuelve_bloques, que se describen arriba.  Se le debe especificar el número de veces que 
    se requiere quer se corra el algoritmo, el límite inferior y superior de la dimensión de la matriz y 
    ...
    * Entradas:
        ...
        la matriz como entrada
    * Salidas:
        - resultados_bloques (data frame): data frame con 5 columnas: dimension_A, condicion_A, 
        tiempo_bloques, solucion_bloques y error_absoluto
    ==========
    Ejemplo:
        >> num_corridas = 3
        >> dim_limite_inf = 2 
        ...
        > resultados_bloques
        >|          | dimension_A | condicion_A | tiempo_bloques | resultados_bloques |error_absoluto|
         |:--------:|:-----------:|:-----------:|:--------------:|--------------------|--------------|
         |     0    |      55     |  184.490589 |    0.088470    |       Correcto     | 4.676325e-09 |
         |     1    |      18     |  62.869150  |    0.007024    |       Correcto     | 9.742454e-13 |
         |     2    |       8     |  26.888839  |    0.002258    |       Correcto     | 4.218847e-14 |
    '''
    dimension_A=[]
    condicion_A=[]
    tiempo_bloques=[]
    ...
    data={'dimension_A':dimension_A, 'condicion_A':condicion_A,'tiempo_bloques':tiempo_bloques,'solucion_bloques':solucion_bloques,'error_absoluto':error_absoluto}       
